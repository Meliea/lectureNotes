...
//Interpolation
//lets you use string with dynamic content (they require backticks)
...
Denoted by {}
Have keys and values (color (key): 'blue' (value), separated with a colon, adn each
key-value pair is separated with a common.
*/
